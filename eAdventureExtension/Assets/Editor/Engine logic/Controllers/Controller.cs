...
public class Controller
{
    ...
    public void init(string loadProjectPath)
    {
        ...
        else 
        {
            ...
            //}
            if (NewGameWindow.selectedGameType == NewGameWindow.GameType.FPS)
            {
                newFile(FILE_ADVENTURE_1STPERSON_PLAYER);
            }
            else
            {
        ...
        try
        {
            ...
            if (completeFilePath != null)
            {
                ...
                AdventureData loadedAdventureData =
                    Loader.loadAdventureData(
                        AssetsController.InputStreamCreatorEditor.getInputStreamCreator(completeFilePath), incidences);
